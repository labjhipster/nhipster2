...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8080';
    'jhipster.clientApp.name' = 'bootifulmusic';
    ...
    'jhipster.mail.from' = 'bootifulmusic@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'bootifulmusic API';
    'jhipster.swagger.description' = 'bootifulmusic API documentation';
    ...
    'eureka.instance.appname' = 'bootifulmusic';
    'eureka.instance.instanceId' = 'bootifulmusic:${random.value}';
    ...
    'cloud.config.name' = 'bootifulmusic';
